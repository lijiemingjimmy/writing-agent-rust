...
本项目复用了作者此前写作教练项目（<https://github.com/lijiemingjimmy/writing-coach-agent>）中的 React 学生界面、课程 Skill 配置、课程语料组织方式和业务测试案例；这些均为作者本人此前完成的项目资产。Agent 主控、长对话记忆、输入安全、运行状态、取消、Token/费用、会话轨迹和 Rust API 由本课程项目中的 Rust 实现承担。原项目的 Git 历史、Python 服务、教师端、数据库、部署配置和真实用户数据均未包含。
